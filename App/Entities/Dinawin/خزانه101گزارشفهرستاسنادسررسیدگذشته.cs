...
{
    public partial class خزانه101گزارشفهرستاسنادسررسیدگذشته : DinawinBaseEntity, IMyEntityDinawin
    {
        ...
        public byte? TrsDcCMnthSi { get; set; }
        ...
        public int? AccLtSiRsr { get; set; }
        public string AccLtCuRsr { get; set; }
        public string AccLtTpRsr { get; set; }
        public DateTime? TrsDcCDt2 { get; set; }
        public string TrsDcCCuDoc { get; set; }
        public short Expr1 { get; set; }
        public int? AccLpSiRsr { get; set; }
        public string AccLpCuRsr { get; set; }
        public string AccLpTpRsr { get; set; }
        public int? AccLcSiRsr { get; set; }
        public string AccLcCuRsr { get; set; }
        public string AccLcTpRsr { get; set; }
