...
{
    [Serializable]
    public abstract class BaseNotIdDto<TDto, TEntity, TKey> : IHaveCustomMapping
           ...
           where TEntity : IEntity, new()
    {
        ...
        protected TDto CastToDerivedClass(BaseNotIdDto<TDto, TEntity, TKey> baseInstance)
        {
    ...
    [Serializable]
    public abstract class BaseNotIdDto<TDto, TEntity> : BaseNotIdDto<TDto, TEntity, int>
        where TDto : class, new()
        where TEntity : IEntity, new()
    {
